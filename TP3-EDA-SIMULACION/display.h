...
void displaypiso(unsigned int cantidad_filas, unsigned int cantidad_columnas, int arreglo[FIL][COL], double H, double W); //funcion para actualizar el display del piso
